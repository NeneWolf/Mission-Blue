            ...
            for (int i = 0; i < Bones.Length; i++)
            {
                ...
                if (LookAtWeight != 0)
                {
                    if (bn.external && !IsAiming)
                    {
                        ...
                        bn.bone.rotation = Quaternion.Lerp(bn.bone.rotation, bn.nextRotation, LookAtWeight);
                    }
                    else
                    {
                ...
                //else if (LookAtWeight == 0)
                //{
                //    if (bn.external && !IsAiming)
                //    {
                //        bn.bone.rotation = bn.defaultRotation;
                //        bn.nextRotation = bn.defaultRotation;
                //    }
                //}
            }
        }
